 ...
 */
void IRAM_ATTR_FUN mad_header_init(struct mad_header *header)
{
  header->layer          = 0;
  header->mode           = 0;
 ...
 */
void IRAM_ATTR_FUN mad_frame_init(struct mad_frame *frame)
{
 ...
 */
void IRAM_ATTR_FUN mad_frame_finish(struct mad_frame *frame)
{
 ...
 */
static
int IRAM_ATTR_FUN decode_header(struct mad_header *header, struct mad_stream *stream)
{
  unsigned int index;
 ...
 */
static
int IRAM_ATTR_FUN free_bitrate(struct mad_stream *stream, struct mad_header const *header)
{
 ...
 */
int IRAM_ATTR_FUN mad_header_decode(struct mad_header *header, struct mad_stream *stream)
{
 ...
 */
int IRAM_ATTR_FUN mad_frame_decode(struct mad_frame *frame, struct mad_stream *stream)
{
 ...
 */
void IRAM_ATTR_FUN mad_frame_mute(struct mad_frame *frame)
{
  unsigned int s, sb;
