...
static inline
signed short IRAM_ATTR_FUN scale(mad_fixed_t sample)
{
 ...
 */
void IRAM_ATTR_FUN mad_synth_init(struct mad_synth *synth)
{
 ...
 */
void IRAM_ATTR_FUN mad_synth_mute(struct mad_synth *synth)
{
  unsigned int ch, s, v;
...
static
void IRAM_ATTR_FUN dct32(mad_fixed_t const in[32], unsigned int slot,
...
void IRAM_ATTR_FUN synth_full(struct mad_synth *, struct mad_frame const *,
 ...
 */
static
void  IRAM_ATTR_FUN synth_full(struct mad_synth *synth, struct mad_frame const *frame,
		unsigned int nch, unsigned int ns)
{
  ...
  for (s = 0; s < ns; ++s)
  {
    ...
    extern void render_sample_block(short *short_sample_buff, int no_samples);
    /* Render di un blocco */
 ...
 */
static
void IRAM_ATTR_FUN synth_half(struct mad_synth *synth, struct mad_frame const *frame,
		unsigned int nch, unsigned int ns)
{
  unsigned int phase, ch, s, sb, pe, po;
  short int *pcm1, *pcm2;
...
extern void IRAM_ATTR_FUN set_dac_sample_rate(int rate);
/*
 * NAME:	synth->frame()
